...
func securityRelevanceScore(path string, text string) int {
	...
	for token, weight := range map[string]int{
		...
		"setcookie": 34, "cookiehttponly": 22, "secure flag": 28,
		"secure bool": 24, "opt.secure": 34, "secure=false": 28,
		"x-csrf-token": 38, "csrf.valid": 30, "csrf.validate": 30,
		"=== token": 30, "== token": 24, "scmp": 22, "timingsafeequal": 30,
		"constant-time": 28, "constant time": 28,
		"commentre": 38, "regexp": 26, "regex": 22, "redos": 34,
		"[^*]*\\*+": 38, "([^/*][^*]*\\*+)*": 40,
		"replace(commentre": 34, ".replace(/": 16, ".match(/": 16,
		...
		"loadfromassemblypath": 54, "appcontext.basedirectory": 40,
		"assemblyloadcontext": 34, "typename.split": 28, "splitname[1]": 34,
		"typeloadexception": 18,
