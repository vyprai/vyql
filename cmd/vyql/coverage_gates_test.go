...
func TestRuleFiresCoverageGate(t *testing.T) {
	unspecced := map[string]bool{
		...
		// code rules still to spec (T1.1):
		"VYQL-DESER-003": true, "VYQL-INJ-007": true, "VYQL-INJ-009": true, "VYQL-INJ-010": true,
		"VYQL-PATH-002": true, "VYQL-RF-003": true, "VYQL-SC-002": true, "VYQL-SEC-001": true,
	}
