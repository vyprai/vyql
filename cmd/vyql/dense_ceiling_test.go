...
// (--max-ram 4GB --cache off); before the fix it stopped at 3.3 GiB of resident memory
// with a zero-byte report, and the same invocation now finishes with findings.
