...
var languages = sync.OnceValue(func() []Language {
	return []Language{
		...
		{"config", map[string]bool{".xml": true, ".plist": true, ".yaml": true, ".yml": true,
			".tf": true, ".cfg": true, ".json": true, ".jelly": true, ".jsp": true, ".tag": true, ".gsp": true, ".twig": true, ".jst": true, ".def": true, ".svelte": true, ".html": true, ".erb": true, ".pest": true, ".sch": true, ".php": true, "dockerfile": true}, cfgfront.Extract, bindings.ConfigBindings},
