...
func TestGroupedPackageCatalogsCoverSupportedLanguages(t *testing.T) {
	cases := []struct {
		...
		{"csharp", ".cs", packageCatalogMapping{"Microsoft.AspNetCore.Http", "Request.Query", false, "code.HttpInput", 0}, packageCatalogMapping{"Dapper", "Query", true, "code.SqlExecution", 0}, packageCatalogMapping{"System.Text.Encodings.Web", "HtmlEncoder.Encode", false, "core.HtmlEscape", 0}},
		{"dart", ".dart", packageCatalogMapping{"shelf", ".queryParameters", false, "code.HttpInput", 0}, packageCatalogMapping{"sqflite", "rawQuery", true, "code.SqlExecution", 0}, packageCatalogMapping{"dart:convert", "htmlEscape.convert", false, "core.HtmlEscape", 0}},
		...
		{"go", ".go", packageCatalogMapping{"net/http", ".URL.Query", false, "code.HttpInput", 0}, packageCatalogMapping{"database/sql", "Query", true, "code.SqlExecution", 0}, packageCatalogMapping{"html", "html.EscapeString", false, "core.HtmlEscape", 0}},
		...
		{"java", ".java", packageCatalogMapping{"javax.servlet", ".getParameter", false, "code.HttpInput", 0}, packageCatalogMapping{"java.sql", "executeQuery", true, "code.SqlExecution", 0}, packageCatalogMapping{"commons-text", "StringEscapeUtils.escapeHtml4", false, "core.HtmlEscape", 0}},
		{"javascript", ".js", packageCatalogMapping{"express", "req.body", false, "code.HttpInput", 0}, packageCatalogMapping{"sequelize", "sequelize.query", false, "code.SqlExecution", 0}, packageCatalogMapping{"dompurify", "DOMPurify.sanitize", false, "core.HtmlEscape", 0}},
		{"kotlin", ".kt", packageCatalogMapping{"javax.servlet", ".getParameter", false, "code.HttpInput", 0}, packageCatalogMapping{"java.sql", "executeQuery", true, "code.SqlExecution", 0}, packageCatalogMapping{"commons-text", "StringEscapeUtils.escapeHtml4", false, "core.HtmlEscape", 0}},
		...
		{"rust", ".rs", packageCatalogMapping{"actix-web", "query", true, "code.HttpInput", 0}, packageCatalogMapping{"sqlx", "query", true, "code.SqlExecution", 0}, packageCatalogMapping{"ammonia", "ammonia.clean", false, "core.HtmlEscape", 0}},
		{"scala", ".scala", packageCatalogMapping{"playframework", ".getQueryString", false, "code.HttpInput", 0}, packageCatalogMapping{"slick", "sql", false, "code.SqlExecution", 0}, packageCatalogMapping{"twirl", "HtmlFormat.escape", false, "core.HtmlEscape", 0}},
		...
		{"swift", ".swift", packageCatalogMapping{"vapor", "query", true, "code.HttpInput", 0}, packageCatalogMapping{"fluent", "raw", true, "code.SqlExecution", 0}, packageCatalogMapping{"vapor", "String.htmlEscaped", false, "core.HtmlEscape", 0}},
	}
